...
public class level6 extends Levels {
     ...
     */
    public level6(ImageView imageView, ImageView foreground, ImageView crossHair, Stage window, double scale) {
        super(imageView, foreground, crossHair, window, scale, 9,6,new Duck[]{
                new Duck(256 * scale, 240 * scale, 27 * scale, 31 * scale, 5 * scale,  Duration.seconds(1), blackDuckImages, 7 * scale, true,10*scale,10*scale),
                new Duck(256 * scale, 240 * scale, 27 * scale, 31 * scale, 5 * scale,  Duration.seconds(1), redDuckImages, 7 * scale, true,200*scale,150*scale),
                new Duck(256 * scale, 240 * scale, 27 * scale, 31 * scale, 5 * scale,  Duration.seconds(1), blueDuckImages, 7 * scale, true,200*scale,20*scale)
        });
    }
}